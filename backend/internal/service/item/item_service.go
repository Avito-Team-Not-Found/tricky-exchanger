...
// hard-резерваций и объектного хранилища фото.
func NewService(repo ItemRepository, reservations ReservationChecker, storage Storage) *Service {
	return &Service{repo: repo, reservations: reservations, storage: storage}
}
