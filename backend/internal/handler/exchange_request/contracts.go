...
type exchangeRequestService interface {
	Create(ctx context.Context, userID string, input requestservice.CreateInput) (entity.ExchangeRequest, error)
	Get(ctx context.Context, userID string, requestID int64) (entity.ExchangeRequest, error)
	List(ctx context.Context, userID string) ([]requestservice.ListItem, error)
	Update(ctx context.Context, userID string, requestID int64, input requestservice.UpdateInput) (entity.ExchangeRequest, error)
