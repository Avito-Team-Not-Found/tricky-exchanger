...
var (
	...
	ErrExchangeRequestNotFound = errors.New("заявка на обмен не найдена")
	ErrExchangeRequestForbidden = errors.New("заявка на обмен принадлежит другому пользователю")
	ErrExchangeRequestVersionConflict = errors.New("заявка на обмен уже была изменена")
	ErrExchangeRequestLocked = errors.New("заблокированную заявку нельзя изменить или удалить")
