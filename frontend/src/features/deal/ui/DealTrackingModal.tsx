...
// Этапы трекинга из макета «4.9 Модальное окно — Трекинг». Событий и времени API не отдаёт —
// показываем фиксированный список, «пройденность» считаем по requestStatus участника, без дат
// (DEAL-PLAN.md §4.3): LOCKED — ничего, IN_PROGRESS — всё до «Доставлено в пункт выдачи»,
// DONE — ещё и «Получено».
