...
// минимальная длина описания — требование из UX-задачи (SCRUM-52), общее для описания товара
// и описания желаемого в заявке; единая точка для правила формы и гейта кнопки,
// дублировать число в двух местах нельзя
