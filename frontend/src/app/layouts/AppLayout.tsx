...
// экраны цепочки — полноэкранный подпоток: у экрана своя шапка, а низ занимает
// кнопка действия, поэтому глобальной шапки и таб-бара нет. Цепочки — только мобильные экраны:
// боковое меню десктопа остаётся, там кнопка действия ничего не перекрывает
